...
public class UserService {
    ...
    public boolean isHasUserByName(String username,String passsword) {
        return this.passwordEncoder.matches(userMapper.selectUserByUsername(username).getPassword(),passsword) ;
    }
